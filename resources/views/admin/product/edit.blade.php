                ...
                <div class="card-body">
                    <form id="product" class="forms-sample" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="short_description" id="short_description" rows="10">{{ $data->short_description }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="price" class="form-control" id="price" value="{{ $data->price }}" step="0.01">
                            <p class="error"></p>
                        </div>

                        <div class="mb-3">
                            <label for="sale_price" class="form-label">Sale Price</label>
                            <input type="number" name="sale_price" class="form-control" id="sale_price" value="{{ $data->sale_price }}" step="0.01">
                            <p class="error"></p>
                        </div>

                        <div class="mb-3">
                            <label for="SKU" class="form-label">SKU</label>
                            <input type="text" name="SKU" class="form-control" id="SKU" value="{{$data->SKU }}">
                            <p class="error"></p>
                        </div>
                        ...
                        <div class="form-check form-check-inline mb-3">
                            <input type="checkbox" name="featured" class="form-check-input" id="Featured" value="1" {{$data->featured == 1 ? 'checked' : ''}}>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2" id="image-preview">
                                <img src="{{ asset('/product/image/' . $data->image) }}" id="preview-img" style="max-width: 150px; height: auto; border: 1px solid #ddd; padding: 5px;" />
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2" id="gallery-preview">
                                ...
                                <img src="{{ asset('product/gallery/' . $image) }}" alt="Gallery Image" style="max-width: 150px; height: auto; border: 1px solid #ddd; padding: 5px; margin-right: 10px;">
                                @endforeach
                                @endif
                            </div>
                        </div>
...
<script>
    ...
    $('#product').on('submit', function(e) {
        ...
        $.ajax({
            ...
            type: "POST", // ✅ Keep it POST because we're spoofing PUT with _method
            data: formData,
            contentType: false,
            processData: false,
            headers: {
