                    ...
                    <div id="accordion-filter-1" class="accordion-collapse collapse show border-0" aria-labelledby="accordion-heading-1" data-bs-parent="#categories-list">
                        <div class="accordion-body px-0 pb-0 pt-3">
                            <ul class="list list-inline mb-0">
                                ...
                                <li class="list-item">
                                    <label>
                                        <input type="checkbox" class="category-checkbox" value="{{ $category->id }}" @if ($filter_category && in_array($category->id, explode(',', $filter_category))) checked @endif
                                        >
                                        {{ $category->name }}
                                    </label>
                                    <span class="text-end float-end">{{ $category->product->count() }}</span>
                                </li>
                                @endforeach
            ...
            <div class="accordion" id="brand-filters">
                <div class="accordion-item mb-4 pb-3">
                    ...
                    <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0" aria-labelledby="accordion-heading-brand" data-bs-parent="#brand-filters">
                        <div class="search-field accordion-body px-0 pb-0">

                            <ul class="list list-inline mb-0 brand-list">
                                @foreach ($brands as $brand)
                                <li class="list-item">
                                    <label>
                                        <input type="checkbox" class="brand-checkbox" value="{{ $brand->id }}" @if ($filter_brand && in_array($brand->id, explode(',', $filter_brand))) checked @endif
                                        >
                                        {{ $brand->name }}
                                    </label>
                                    <span class="text-end float-end">{{ $brand->product->count() }}</span>
                                </li>
                                @endforeach
                            </ul>
            ...
            <div class="accordion" id="price-filters">
                <div class="accordion-item mb-4">
                    ...
                    <div id="accordion-filter-price" class="accordion-collapse collapse show border-0" aria-labelledby="accordion-heading-price" data-bs-parent="#price-filters">
                        <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="10" data-slider-max="15000" data-slider-value="[{{$min_price}},{{$max_price}}]" data-slider-step="5" data-currency="$" />
                        <div class="price-range__info d-flex align-items-center mt-2">
                            ...
                            <div>
                                ...
                                <span class="price-range__max">$15000</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="{{ route('shop.product_detail', $product->slug) }}"><img loading="lazy" src="{{asset('product/image/' .$product->image)}}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        @foreach(json_decode($product->gallery, true) as $image)
                                        <a href="{{ route('shop.product_detail', $product->slug) }}"><img loading="lazy" src="{{ asset('product/gallery/' . $image) }}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                                        @endforeach
                        ...
                        <div class="pc__info position-relative">
                            ...
                            <h6 class="pc__title"><a href="{{ route('shop.product_detail', $product->slug) }}">{{$product->name}}</a></h6>
                            ...
                            <button class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist" title="Add To Wishlist" style="color:#9c7539">
